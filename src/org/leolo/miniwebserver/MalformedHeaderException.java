...
public final class MalformedHeaderException extends RuntimeException {
	...
	public MalformedHeaderException(String message, Throwable cause, boolean enableSuppression,
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4146619960370363919L;
